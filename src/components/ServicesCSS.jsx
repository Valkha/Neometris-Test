                ...
                <div id='vvi' name='VVI' className='w-11/12 lg:w-9/12 h-[150px] xl:h-[350px] 2xl:h-[400px] flex flex-col mt-24 '>
                    <div className='w-full h-5/6 flex justify-between bg-zinc-900 rounded-r-full shadow-xl shadow-gray-500 relative'>
                        ...
                        <div className="w-2/3 lg:w-2/3 h-full lg:mt-0 text-center flex flex-col justify-evenly items-center absolute right-6 lg:right-0 ">
                            ...
                            <p className='w-full max-w-[700px] md:max-w-[300px] lg:max-w-[500px] 2xl:max-w-[700px] text-gray-300 text-[0.6rem] lg:text-xl mx-auto'>Experts en capture 3D, nous avons à cœur de réaliser votre jumeau numérique avec la plus grande précision, pour un résultat de qualité et dans le respect de votre identité visuelle</p>
                    ...
                    <div id='drone' name='drone' className='w-11/12 lg:w-9/12 h-[170px] xl:h-[350px] 2xl:h-[400px] flex flex-col mt-24 '>
                        <div className='w-full h-5/6 flex justify-between bg-zinc-900 rounded-l-full shadow-xl shadow-gray-500 relative mr-32'>
                            ...
                            <div className="order-1 w-2/3 h-full text-center flex flex-col justify-evenly items-center absolute left-6 lg:left-0 ">
                                ...
                                <p className=' w-full max-w-[180px] md:max-w-[300px] lg:max-w-[500px] 2xl:max-w-[700px] text-gray-300 text-[0.5rem] lg:text-xl mx-auto'>Prenez de la hauteur ! Nous réalisons vos photos et vidéos aériennes dans le respect de la règlementation et en toute sécurité. Agréés par la DGAC -Direction Générale de l’Avion Civile- nous intervenons sur tous les secteurs.</p>
                                <div className='w-2/3 flex justify-center items-center mx-auto'>
                ...
                <div id='photo' name='photo' className='w-9/12 h-[230px] xl:h-[350px] 2xl:h-[400px] flex flex-col mt-24'>
                    <div className='w-full h-5/6 flex justify-between bg-zinc-900 rounded-r-full shadow-xl shadow-gray-500 relative'>
                        ...
                        <div className="w-2/3 lg:w-2/3 h-full lg:mt-0 text-center flex flex-col justify-evenly items-center absolute right-6 lg:right-0 ">
                            ...
                            <p className='w-full max-w-[700px] md:max-w-[300px] lg:max-w-[500px] 2xl:max-w-[700px] text-gray-300 text-[0.6rem] lg:text-xl mx-auto'>« On a qu’une seule occasion de faire une première bonne impression »<br></br> Sublimez votre image avec des photographies professionnelles</p>
                            <div className='w-2/3 flex justify-center items-center mx-auto'>
